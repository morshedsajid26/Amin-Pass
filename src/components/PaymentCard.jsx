    ...
    <div className="bg-[#AFC5D3] dark:bg-[#7AA3CC]/50 rounded-2xl p-8 w-[50%] shadow-md mt-10 mx-auto  dark:border dark:border-[#CFCFCF]">
      ...
      <div className="flex justify-between items-center mb-6">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-inter font-semibold text-[#000000] dark:text-white">
            Add new card
          </h2>
        </div>
      ...
      <div className="mb-5  grid grid-cols-7 items-center gap-4">
        ...
        <input
          type="text"
          placeholder=""
          className="col-span-4 py-2 px-3.5 rounded-lg bg-white outline-none font-inter text-[#000000]"
        />
      </div>
      ...
      <div className="grid grid-cols-7 items-center gap-5 mb-5">
        ...
        <div className="col-span-2">
          ...
          <p className="text-sm text-[#333333] dark:text-[#C5C5C5] mb-2">Security code</p>
        </div>
          <input
            type="password"
            placeholder="012"
            className="w-15 py-2 px-0 rounded-lg bg-white  outline-none text-[#000000] font-inter text-center"
          />
        </div>
      </div>
...
{/* Save for next payment */}
      <div className="flex items-center justify-center gap-3 mt-5 ">
        <input
          ...
          className="w-5 h-5 accent-[#000000] dark:accent-white"
        />
        <label className="text-[#000000] dark:text-white font-inter text-[16px]">
