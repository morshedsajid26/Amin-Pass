...
const ProgressBar = ({ data }) => {
  ...
  return (
    <div className="bg-[#F9F9F9] dark:bg-transparent dark:border dark:border-white  p-6 rounded-2xl ">
      ...
      <div className="flex flex-col gap-7">
        {data.map((item, i) => (
          <div key={i} className="f items-center justify-between gap-4">
            {/* Label */}
            <p className="font-semibold  w-24 font-inter dark:text-white">{item.title}</p>
<div className="flex items-center gap-20 mt-2">
            ...
            {/* Value */}
            <span className="text-sm font-semibold font-inter w-20 dark:text-white">
              {item.claims}{" "}
