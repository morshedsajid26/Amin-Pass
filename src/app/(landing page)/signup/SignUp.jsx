...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("http://127.0.0.1:8000/api/business-register", {
        method: "POST",
        body: formData,
      });
      ...
      <Container className="flex flex-col items-center py-20 px-11 h-screen overflow-y-auto hide-scrollbar">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="bg-[#7AA3CC] text-[#010101] font-semibold text-xl font-inter py-3 px-20 rounded-2xl cursor-pointer mt-12"
          >
