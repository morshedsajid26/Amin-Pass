...
const FeaturedItem = () => {
  return (
    <div className='py-17'>
        <Container>
            <h3 className=' font-inter font-bold text-[32px] text-center '>Featured Items</h3>

        <div className='grid grid-cols-2 gap-8 mt-8'>

            <div className='bg-[#E9F0F5] rounded-2xl px-12 flex flex-col justify-center  text-center items-center py-15'>
                <Image src={one} alt='featured'/>
                <p className=' font-inter font-medium text-[36px] my-6'>Design Your Own Loyalty Card</p>
                <p className=' font-inter font-medium '>Design a branded loyalty card yourself in just a few minutes.</p>
            </div>
             <div className='bg-[#E9F0F5] rounded-2xl px-12 flex flex-col justify-center items-center py-15 text-center'>
                <Image src={two} alt='featured'/>
                <p className=' font-inter font-medium text-[36px] my-6'>Work in apple/Google Wallet</p>
             ...
             <div className='bg-[#E9F0F5] rounded-2xl px-12 flex flex-col justify-center items-center py-15 text-center'>
                ...
                <p className=' font-inter font-medium text-[36px] my-6'>Real-time Updates</p>
             ...
             <div className='bg-[#E9F0F5] rounded-2xl px-12 flex flex-col justify-center items-center py-15 text-center'>
                ...
                <p className=' font-inter font-medium text-[36px] my-6'>Easy Setup,no hardware</p>
