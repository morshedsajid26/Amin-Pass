    ...
    <div className='pb-20'>
      ...
      <div className='grid grid-cols-12 gap-10 mt-6'>
        <div className='bg-[#E9F0F5] col-span-4 rounded-2xl px-10 py-7 flex flex-col items-center text-center gap-4'>
            ...
            <p className='font-inter font-medium text-2xl'> Over 2,300 rewards redeemed monthly keeping customers</p>
        </div>
        <div className='bg-[#E9F0F5] col-span-4 rounded-2xl px-10 py-7 flex flex-col items-center text-center gap-4'>
            <Image src={impact2} alt='works1'/>
            <p className='font-inter font-medium text-2xl'> Generates €12,500 in recurring customer value every month</p>
        </div>
        <div className='bg-[#E9F0F5] col-span-4 rounded-2xl px-4 py-7 flex flex-col items-center text-center gap-4'>
            ...
            <p className='font-inter font-medium text-2xl'> 38% increase in repeat visits through automated rewards</p>
        </div>
