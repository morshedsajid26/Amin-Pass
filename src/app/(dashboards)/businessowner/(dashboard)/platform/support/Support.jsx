    ...
    <div>
      ...
      <div className="flex flex-col md:flex-row  md:items-center gap-2 md:gap-16 ">
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <input
            type="text"
            className="border outline-none border-[#000000] py-3 px-12 md:w-[462px] rounded-[15px] text-[#000000] placeholder:text-[#000000] font-inter"
            placeholder="Search"
          />
        ...
        <div>
          ...
          <button className="bg-[#7AA3CC] font-inter font-medium py-3 px-2 md:px-11 rounded-lg text-[#121212] cursor-pointer  hover:bg-[#7AA3CC]/80 transition-all duration-300">
            Create Support
          </button>
          </Link>
        </div>
