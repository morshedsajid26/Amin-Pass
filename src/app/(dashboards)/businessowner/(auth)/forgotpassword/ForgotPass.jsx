...
const ForgotPass = () => {
  return (
     <main className="bg-white  dark:bg-[#141414] grid justify-center items-center overflow-y-auto hide-scrollbar py-30 px-11 rounded-3xl  ">
      ...
      <h3 className='font-inter font-medium text-[32px] text-[#333333] dark:text-white'>Forget Password?</h3>

      <p className='font-inter  text-[#333333] dark:text-white mb-5'>Please enter your email to get verification code</p>
     ...
     <Link href='/businessowner/otp' className='w-full'>
